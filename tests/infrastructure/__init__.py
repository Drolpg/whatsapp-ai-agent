...
tecnologia de verdade (Ollama, FAISS, Twilio). Sao os mais lentos e
frageis da suite, e por isso ficam isolados aqui: uma falha neste diretorio
aponta pra integracao, nunca pra regra de negocio.
